...
const dict: Dict = {
  ...
  contact_name:{en:"Name",zh:"姓名"}, contact_email:{en:"Email",zh:"邮箱"}, contact_phone:{en:"Phone (optional)",zh:"电话（可选）"}, contact_notes:{en:"Notes",zh:"备注（风格/预算/时间）"}, contact_send:{en:"Send",zh:"发送"}, contact_ok:{en:"Submitted. We'll reply soon.",zh:"提交成功，我们会尽快联系你。"},
  footer_privacy:{en:"Privacy",zh:"隐私"}, footer_terms:{en:"Terms",zh:"条款"},
};
type I18nCtx={lang:Lang; t:(k: keyof typeof dict)=>string; setLang:(l:Lang)=>void;};
export const I18nContext=React.createContext<I18nCtx|null>(null);
export default function I18nProvider({children}:{children:React.ReactNode}){
  const [lang,setLang]=React.useState<Lang>('en'); // always EN default
